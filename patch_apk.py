...
def copy_script_temp():
    src = os.path.join(os.getcwd(), "messenger-ssl-pinning-bypass.js")
    # added lib prefix and so extension so script is copied into /data/data/com.facebook.android/lib
...
def main():
    parser = argparse.ArgumentParser(
        description='Remove ssl pining from facebook app')
